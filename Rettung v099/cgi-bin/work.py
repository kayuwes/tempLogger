    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Time', 'Ch0 HWR@NAS', 'Ch1 Schlafzimmer', 'Ch2 Draussen'],
%s
        ]);
...
#    print "<h2>Temperature Chart</h2>"
    print '<div id="chart_div" style="width: 1000px; height: 400px;"></div>'
...
#    rowstrnow="&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{0}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{1}F&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{2}F&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{3}F&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{4}F&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{5}F".format(str(rownow[0]),str(rownow[1]),str(rownow[2]),str(rownow[3]))
    rowstrnow="&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{0}C&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{1}C&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{2}C".format(str(rownow[1]),str(rownow[2]),str(rownow[3]))


    print "<hr>"

    print "<h3>Current Temperatures&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCh0&nbsp&nbsp&nbsp&nbsp&nbspCh1&nbsp&nbsp&nbsp&nbsp&nbspCh2</h3>"
#&nbsp&nbsp&nbsp&nbsp&nbspCh3&nbsp&nbsp&nbsp&nbsp&nbspCh4</h2>"
    print rowstrnow
    print "<h3>Minimum Temperature &nbsp&nbsp&nbsp&nbspCh0&nbsp&nbsp&nbsp&nbsp&nbspCh1&nbsp&nbsp&nbsp&nbsp&nbspCh2</h3>"
#&nbsp&nbsp&nbsp&nbsp&nbspCh3&nbsp&nbsp&nbsp&nbsp&nbspCh4</h2>"
#    print rowstrmin0, rowstrmin1, rowstrmin2, rowstrmin3, rowstrmin4
    print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin0+"C", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin1+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin2+"F"
#, "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin3+"F", "&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin4+"F"
    print "<h3>Maximum Temperature &nbsp&nbsp&nbspCh0&nbsp&nbsp&nbsp&nbsp&nbspCh1&nbsp&nbsp&nbsp&nbsp&nbspCh2</h3>"
#&nbsp&nbsp&nbsp&nbsp&nbspCh3&nbsp&nbsp&nbsp&nbsp&nbspCh4</h2>"
...
#, "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmax3+"F"
    print "<h3>Average Temperatures &nbsp&nbsp&nbsp&nbspCh0&nbsp&nbsp&nbsp&nbsp&nbspCh1&nbsp&nbsp&nbsp&nbsp&nbspCh2</h3>"
#&nbsp&nbsp&nbsp&nbsp&nbspCh3&nbsp&nbsp&nbsp&nbsp&nbspCh4</h2>"
...
#, "&nbsp&nbsp&nbsp&nbsp%.3f" % rowavg3+"F", "&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowavg4+"F"

    print "<hr>"

    print "<h3>In the last hour:</h3>"
    print "<table>"
    print "<tr><td><strong>Date/Time</strong></td><td><strong>Ch0 Temp</strong>&emsp;&emsp;</td><td><strong>Ch1 Temp</strong>&emsp;&emsp;&emsp;</td><td><strong>Ch2 Temp</strong>&emsp;&emsp;&emsp;</td></tr>"
#<td><strong>Ch3 Temp</strong>&emsp;&emsp;&emsp;</td><td><strong>Ch4 Temp</strong></td></tr>"
...
#    rows=curs.execute("SELECT * FROM temps WHERE timestamp>datetime('2014-03-18 00:00:00','-1 hour') AND timestamp<=datetime('2014-03-18 20:45:00')")
    for row in rows:
       # rowstr="<tr><td>{0}&emsp;&emsp;</td><td>{1}F&emsp;&emsp;</td><td>{2}F&emsp;&emsp;$
	rowstr="<tr><td>{0}&emsp;&emsp;</td><td>{1}F&emsp;&emsp;</td><td>{2}F&emsp;&emsp;</td><td>{3}F&emsp;&emsp;</td></tr>".format(str(row[0]),str(row[1]),str(row[2]),str(row[3]))
#,str(row[5]))
...
def print_time_selector(option):
    ...
    if option is not None:
        ...
        if option == "36":
            print "<option value=\"36\" selected=\"selected\">the last 36 hours</option>"
        else:
            print "<option value=\"36\">the last 36 hours</option>"
...
def main():
    ...
    # print the page body
    print "<body>"
    print "<h2>Temperature Logger</h2>"
    print "<a href='/remote/heizung.php'>", "zurueck", "</a>"           
    print "<hr>"
