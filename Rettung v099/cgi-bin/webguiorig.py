...
#    curs.execute("SELECT avg(temp0) FROM temps WHERE timestamp>datetime('2014-03-18 00:00:00','-%s hour') AND timestamp<=datetime('2014-03-18 20:45:00')" % option)
    ...
    curs.execute("SELECT MAX(timestamp),temp0,temp1,temp2,temp3,temp4 FROM temps")
...
#    print rowstrmin0, rowstrmin1, rowstrmin2, rowstrmin3, rowstrmin4
    print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin0+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin1+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin2+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin3+"F", "&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowmin4+"F"
...
#    print rowstrmax0, rowstrmax1, rowstrmax2, rowstrmin3, rowstrmin4
    print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowmax0+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmax1+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmax2+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowmax3+"F", "&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowmax4+"F"
    ...
    print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowavg0+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowavg1+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowavg2+"F", "&nbsp&nbsp&nbsp&nbsp%.3f" % rowavg3+"F", "&nbsp&nbsp&nbsp&nbsp&nbsp%.3f" % rowavg4+"F"
...
#    rows=curs.execute("SELECT * FROM temps WHERE timestamp>datetime('2014-03-18 00:00:00','-1 hour') AND timestamp<=datetime('2014-03-18 20:45:00')")
    for row in rows:
        rowstr="<tr><td>{0}&emsp;&emsp;</td><td>{1}F&emsp;&emsp;</td><td>{2}F&emsp;&emsp;</td><td>{3}F&emsp;&emsp;</td><td>{4}F&emsp;&emsp;</td><td>{5}F&emsp;</td></tr>".format(str(row[0]),str(row[1]),str(row[2]),str(row[3]),str(row[4]),str(row[5]))
        print rowstr
    print "</table>"
